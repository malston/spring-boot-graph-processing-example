...
mvn clean test -Dtests=integration -Dspring.neo4j.host="graphdb" -Dserver.host=$TWITTER_CRAWLER_HOST -Dremote.server.port=$TWITTER_CRAWLER_PORT || die "'mvn clean test -Dtests=integration' failed" 1
